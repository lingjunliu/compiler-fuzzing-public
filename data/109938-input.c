...
int t4(int a, int b, int c)
{
  return ((a^c) & b) | a;
}

int t5(int a, int b, int c)
{
  return ((a^c) & b) | a;
}
...
int t7(int a, int b, int c)
{
  return (b & c) | a;
}

int t8(int a, int b, int c)
{
  return ((a^c) & b) | a;
}

int t9(int a, int b, int c)
{
  return ((a^c) & b) | a;
}
...
int t11(int a, int b, int c)
{
  return ((a^c) & b) | a;
}

int t12(int a, int b, int c)
{
  return ((a^c) & b) | a;
}
...
v4si t14(v4si a, v4si b, v4si c)
{
  return ((a^c) & b) | a;
}

v4si t15(v4si a, v4si b, v4si c)
{
  return ((a^c) & b) | a;
}
